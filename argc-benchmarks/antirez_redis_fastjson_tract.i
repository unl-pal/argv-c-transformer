...
extern void abort();
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "antirez_redis_fastjson_tract.c", 54, __extension__ __PRETTY_FUNCTION__); })); }
...
int main(void) {
  ...
  if (!(field_len >= 2 && field_len < 6)) { abort(); }
  char json[16];
  json[0] = '{';
  json[1] = '"';
  json[2] = 'a';
