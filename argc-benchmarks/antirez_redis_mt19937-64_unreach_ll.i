...
extern void abort();
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "antirez_redis_mt19937-64_unreach_ll.c", 70, __extension__ __PRETTY_FUNCTION__); })); }
...
int main(void) {
  ...
  __VERIFIER_assert(r63 == 7257142393139058515);
  return 0;
}
