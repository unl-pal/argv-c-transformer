...
extern void abort();
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "visit-vis_VisIt_enhex_tract.c", 45, __extension__ __PRETTY_FUNCTION__); })); }
