...
extern void abort();
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "plexinc_plex-home-theater-public_getdelim_tract.c", 37, __extension__ __PRETTY_FUNCTION__); })); }
