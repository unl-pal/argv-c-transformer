...
AllFunctionsToCallHandler::AllFunctionsToCallHandler() : _Names(std::vector<std::string>()) {}
...
std::vector<std::string> AllFunctionsToCallHandler::GetNames() { return _Names; }
