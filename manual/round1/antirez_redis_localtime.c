...
void nolocks_localtime(struct tm *tmp, time_t t, time_t tz, int dst) {
    ...
    __VERIFIER_assert(tmp->tm_wday < 7);
...
int main(void) {
    // Required to run 'as user intended'
    // Check comments and test main macro function for further details
    tzset();
    nolocks_localtime((struct tm *)(__VERIFIER_nondet_pointer()), __VERIFIER_nondet_long(), __VERIFIER_nondet_long(), __VERIFIER_nondet_int());
    return 0;
}
